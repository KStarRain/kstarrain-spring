...
//
        ...
        stringRedisTemplate.execute(new RedisCallback<Object>() {
            ...
            public Object doInRedis(RedisConnection connection) throws DataAccessException {
                String value2 = stringSerializer.deserialize(connection.get(stringSerializer.serialize("key_string")));
...
//        System.out.println("管道技术(手写open-close代码)-RedisCallback(序列化键值)   插入 " + values.size() + " 条数据共花费了 " +(end4-start4) +" 毫秒");
        ...
        stringRedisTemplate.executePipelined(new RedisCallback<Object>() {
            @Override
            public Object doInRedis(RedisConnection connection) throws DataAccessException {
                String value = stringSerializer.deserialize(connection.get(stringSerializer.serialize("key_string")));
                System.out.println(value);
                return null;
            }
        });
